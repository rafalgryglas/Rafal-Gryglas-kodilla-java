...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        double arrDayForDoTask = project.getTaskLists().stream()
                .filter(inProgressTask::contains)
                .flatMap(t -> t.getTasks().stream())
                .mapToInt(t1 -> Period.between(t1.getCreated(), LocalDate.now()).getDays())
                .average()
                .orElse(0.0);
        //Then
        Assert.assertEquals(10, arrDayForDoTask, 0.001);
    }
}